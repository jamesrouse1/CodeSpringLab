...

{
  ...
  echo -e "input_representation\tBAMPE fragments"
  echo -e "normalization_method\tMACS2 internal target/control library-depth normalization"
  echo -e "track_note\tCPM and spike-in bedGraphs are not valid MACS2 callpeak inputs; they are retained for SEACR and visualization provenance."
