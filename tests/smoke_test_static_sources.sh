...
grep -Fq 'if (identical(params$qc_preset, "pbmc3k")) plots[[1]] <- plots[[1]] + ggplot2::coord_cartesian(ylim = c(0, NA_real_))' "$repo_root/scripts_DoNotTouch/singleCellRNAseq/scrna_pipeline_seurat.R"
